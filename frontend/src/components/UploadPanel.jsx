...
export default function UploadPanel({ onUploaded }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-3 shadow-sm">
      <h2 className="text-sm font-semibold text-gray-800 mb-2">Upload Filing</h2>
      ...
      <input
        ...
        className="mt-2 w-full border border-gray-200 rounded-lg px-3 py-1.5 text-xs text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-400"
      />

      <button
        onClick={handleUpload}
        disabled={!files.length || uploading}
        className="mt-2 w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-medium py-1.5 rounded-lg transition-colors text-xs"
      >
